        ...
        <div class="row align-items-center top-bar">
            <div class="col-lg-4 col-md-12 text-center text-lg-start">
                <a href="" class="navbar-brand m-0 p-0">
                    ...
                    <img src="<?=base_url()?>/assets/img/logo/Logo-nav.png" alt="Logo" style="width: 48px;"> 
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s" style="font-size: 20px;border-top: 5px solid rgb(36, 159, 253);">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="https://academic.skj.ac.th/LoginStudent" class="btn btn-sm btn-light rounded-pill py-2 px-4 d-none d-lg-block">ดูผลการเรียน</a>
        </div>
    </nav>
    <!-- Navbar End -->