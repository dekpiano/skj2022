...
<section id="features" class="features section">
    ...
    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px; visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
        <h6 class="section-title bg-white text-center text-primary px-3">SKJ Facebook Fanpage</h6>
        <h1 class="display-6 mb-4">แลกเปลี่ยนข่าวสารในโรงเรียน</h1>
    </div>
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                <div class="features-item">
                    <i class="bi bi-camera-video" style="color: #4233ff;"></i>
                    <h3><a target="_blank" href="https://www.facebook.com/CHEER-CLUB-SKJ-444486202632885" class="stretched-link">CHEER CLUB SKJ</a></h3>
                </div>
            </div><!-- End Feature Item -->
